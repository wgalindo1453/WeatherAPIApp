...
public class WeatherDataService {
    ...
    public void getCityID(String cityName, VolleyResponseListener volleyResponseListener){
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                //this worked but didint return the id number to Main
    ...
    public void getCityForecastByID(String cityID, ForeCastByIDResponse foreCastByIDResponse){
        ...
        MySingleton.getInstance(context).addToRequestQueue(request);
                ...
                //get each item in the array and assin it to the new weatherReporModel


    }

    public interface GetCityForecastByNameCallbac{
        void onError(String message);
        void onResponse(List<WeatherReportModel> weatherReportModels);
    ...
    public void getCityForecastByName(String cityName, GetCityForecastByNameCallbac getCityForecastByNameCallbac){
            ...
            public void onResponse(String cityID) {
                ...
                getCityForecastByID(cityID, new ForeCastByIDResponse() {
                    ...
                    public void onResponse(List<WeatherReportModel> weatherReportModels) {
                        ...
                        getCityForecastByNameCallbac.onResponse(weatherReportModels);
        ...
        //fetch the city forcast given city_id
